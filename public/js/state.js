export const state = {
  ...
  plan: 'Free',
  usage: { used: 0, limit: 50000, resetDays: 7, period: 'week', resetAt: null, unit: 'tokens' },
  ...
  auth: { remember: true, busy: false, formError: '', formCode: '', emailDraft: '', preferLogin: false, sessionExpired: false },
